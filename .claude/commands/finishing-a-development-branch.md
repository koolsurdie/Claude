...
- **Option 1:** Merge locally, verify tests on merged result, cleanup worktree, delete branch
- **Option 2:** Push branch, create PR with `gh pr create`, preserve worktree
- **Option 3:** Report keeping branch, preserve worktree
- **Option 4:** Confirm with typed "discard", cleanup worktree, force-delete branch
